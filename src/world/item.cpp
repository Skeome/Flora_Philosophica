...
void ItemDB::_bind_methods() {
    ...
    BIND_CONSTANT(ITEM_FIREPLACE);
    BIND_CONSTANT(ITEM_DRYING_RACK);
    BIND_CONSTANT(ITEM_MORTAR_AND_PESTLE);
    BIND_CONSTANT(ITEM_MACERATION_JAR);
    BIND_CONSTANT(ITEM_COMPOST_BIN);
    BIND_CONSTANT(ITEM_WORK_BENCH);
    BIND_CONSTANT(ITEM_COPPER_ALEMBIC);
    BIND_CONSTANT(ITEM_GLASS_FLASK);
    BIND_CONSTANT(ITEM_GLASSBLOWING_STATION);
    BIND_CONSTANT(ITEM_DISTILLATION_TRAIN);
    BIND_CONSTANT(ITEM_SOXHLET_EXTRACTOR);
    BIND_CONSTANT(ITEM_PELICAN_FLASK);
    BIND_CONSTANT(ITEM_RETORT_TRAIN);
    BIND_CONSTANT(ITEM_TERRARIUM);
    BIND_CONSTANT(ITEM_BOOKSHELF);
    BIND_CONSTANT(ITEM_STORAGE_CHEST);
    BIND_CONSTANT(ITEM_MAILBOX_POST);
    BIND_CONSTANT(ITEM_FURNACE);
    BIND_CONSTANT(ITEM_LEACHING_DISH);
}
